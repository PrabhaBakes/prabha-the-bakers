...
def admin_settings():
    ...
    st=load_settings()
    for k in ["brand_name","tagline","phone","upi_id","upi_name","hero_eyebrow","hero_title","hero_description","hero_image","background_image","footer_tagline","gold"]:
...
def create_order():
    ...
    return jsonify({"order_id":order_id,"amount":total,"upi_id":upi_id,"upi_name":upi_name,"phone":settings.get("phone",CONTACT_PHONE),"items":clean_items})
